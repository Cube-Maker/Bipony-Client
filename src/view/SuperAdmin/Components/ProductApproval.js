...
const ProductApproval = () => {
    return (
        ...
        <h1 className="text-2xl text-center border-b-2 border-gray-800 p-2">Products that needs to be approved</h1>
...

                           {
                               shops.map(shop => {
                                   return <tr key={shop.id} className="whitespace-nowrap text-center">
                                       ...
                                       <td className="px-6 py-4">
                                           <a href="#" className="px-4 py-1 text-sm text-green-800 bg-green-200 rounded-full">Approve</a>
                                       </td>
                                       <td className="px-6 py-4">
