                    ...
                    <ul className="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                        ...
                        <li onClick={() => setComponent("PendingShops")} className="mr-3 flex-1 cursor-pointer">
                            <div className="flex items-center block py-1 md:py-3 pl-1 align-middle no-underline border-b-2 border-gray-800 hover:border-purple-500">
                                ...
                                <div>
                                    <span className={`pb-1 md:pb-0 text-xs md:text-base hover:text-white md:text-gray-400 block md:inline-block ${component} === 'PendingShops' && border-pink-500`}>Pending shops</span>
                                </div>
                            </div>
                        </li>
...
// ${component} === 'ApprovedShops' && text-white
// ${component} === 'ApprovedShops' ? border-pink-500 : ""